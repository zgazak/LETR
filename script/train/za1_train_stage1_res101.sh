...
if [ ! -d "$output"  ]; then
    ...
    --master_port=$((1000 + RANDOM % 9999)) --nproc_per_node=3 --use_env  src/main.py --coco_path /data/zgazak/coco/shs_010118-021818_021918-030118/ \
    --output_dir $output --backbone resnet101 --resume  https://dl.fbaipublicfiles.com/detr/detr-r101-2c7b67e5.pth \
    --batch_size 12 --epochs 500 --lr_drop 200 --num_queries 1000  --num_gpus 3 --layer1_num 3 | tee -a $output/history.txt
