...
class SetCriterion(nn.Module):
    ...
    def loss_length(self, outputs, targets, num_items, origin_indices=None):
        """for lines matched with targets, regularize on the scatter in their lengths as all should be same length"""
